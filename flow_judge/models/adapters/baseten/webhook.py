...
def ensure_baseten_webhook_secret():
    """Requests user to provide baseten webhook secret."""
    ...
    print(
        ...
        f"It will be stored in plain text in {_stored_secret_path} for later use.\n"
    ...
    if not _is_interactive():
        print(
            "Set the Baseten webhook secret in `BASETEN_WEBHOOK_SECRET`"
